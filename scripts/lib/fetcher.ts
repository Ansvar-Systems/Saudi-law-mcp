/**
 * Rate-limited HTTP client for Saudi legislation from the Sejm ELI API.
 *
...
const USER_AGENT = 'Saudi-Law-MCP/1.0 (https://github.com/Ansvar-Systems/saudi-law-mcp; hello@ansvar.ai)';
